...
import { ArrowLeftIcon, User, FileText, Briefcase, GraduationCap, Sparkles, ChevronLeft, ChevronRight, FolderIcon, Share2Icon, EyeIcon, EyeOffIcon, DownloadIcon } from 'lucide-react'
                ...
                p-6 pt-1'>
                   ...
                   <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                    ...
                    <div className='flex items-center'>
                      ...
                      <button onClick={()=> setActiveSectionIndex((prevIndex)=> Math.
                        min(prevIndex + 1, sections.length - 1))} className={`flex items-center gap-1 p-3 rounded-lg
                        text-sm font-medium text-gray-600 hover:bg-gray-50
                    ...
                    <div className='space-y-6'>
                          {activeSection.id === 'personal' && (
                            <PersonalInfo data={resumeData.personal_info} onChange={
            ...
            <div className="lg:col-span-7 max-lg:mt-6">
              <div className='relative w-full'>
                ...
                justify-end gap-2'>
                  ...
                  <button onClick={changeResumeVisibility} className='flex items-center p-2 px-4
                    gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200
                  ...
                  <button onClick={downloadResume} className='flex items-center gap-2 px-6 py-2
