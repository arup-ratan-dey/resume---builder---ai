// import { FilePenLineIcon, PcCaseIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloudIcon, XIcon } from 'lucide-react'
...
//   {
//       const confirm = window.confirm('Are you sure you want to delete this reseme?')
//       if(confirm)
//       {
...
//           bg-clip-text text-transparent sm:hidden'>Welcome, Arup Ratan Dey</p>
...
import { FilePenLineIcon, LoaderCircleIcon, PcCaseIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloudIcon, XIcon } from 'lucide-react'
import React, { useEffect, useState } from 'react'
import { dummyResumeData } from '../assets/assets'
import {useNavigate} from 'react-router-dom'
import { useSelector } from 'react-redux'
